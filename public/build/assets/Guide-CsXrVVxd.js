import{r as x,j as e,H as j,L as k}from"./app-Dzu6_FWC.js";import{B as b}from"./Button-Ck_RVYCE.js";import{A as _,G as o}from"./AppLayout-b-9cVYtn.js";import{A as w}from"./arrow-left-CW7cPFqD.js";import{D as S}from"./download-D6sc5f3s.js";import{C as r}from"./circle-check-big-DuEMrY0M.js";import{C as N}from"./copy-DbDBd95I.js";/* empty css            */import"./AppIcon-CMBqwbLN.js";import"./ToastViewport-DPu9gXC5.js";import"./shield-CdDwm-mT.js";function l({label:a,value:s,copyKey:i,copied:d,onCopy:c}){return e.jsxs("div",{className:"rounded-xl bg-black/40 p-4",children:[e.jsxs("div",{className:"mb-2 flex items-center justify-between gap-3",children:[e.jsx("p",{className:"text-xs font-semibold uppercase tracking-[0.22em] text-white/45",children:a}),e.jsxs("button",{onClick:()=>c(s,i),className:"inline-flex items-center gap-1.5 rounded-lg bg-white/10 px-3 py-1.5 text-xs font-medium text-white/75 transition hover:bg-white/20 hover:text-white",children:[e.jsx(N,{className:"h-3.5 w-3.5"}),d===i?"Tersalin!":"Salin"]})]}),e.jsx("pre",{className:"overflow-x-auto text-xs leading-6 text-white/90",children:e.jsx("code",{children:s})})]})}function P({application:a,appUrl:s}){const[i,d]=x.useState(null),c=`${s}/oauth/authorize`,p=`${s}/oauth/token`,m=`${s}/api/user`,u=`${s}/api/users`,g=a.allowed_organization_types.length>0?a.allowed_organization_types.join(", "):"semua organisasi aktif",h=a.allowed_organization_types.length>0?a.allowed_organization_types.join(","):"internal",t=x.useMemo(()=>({env:`SSO_BASE_URL=${s}
