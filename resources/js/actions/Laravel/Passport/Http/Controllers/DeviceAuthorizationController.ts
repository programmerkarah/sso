 ...
 */
const DeviceAuthorizationController = (
 ...
 * @route '/oauth/device/authorize'
 */
DeviceAuthorizationController.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: DeviceAuthorizationController.url(options),
    method: 'get',
 ...
 * @route '/oauth/device/authorize'
 */
DeviceAuthorizationController.head = (
    options?: RouteQueryOptions,
 ...
 * @route '/oauth/device/authorize'
 */
const DeviceAuthorizationControllerForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/oauth/device/authorize'
 */
DeviceAuthorizationControllerForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: DeviceAuthorizationController.url(options),
    method: 'get',
 ...
 * @route '/oauth/device/authorize'
 */
DeviceAuthorizationControllerForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
